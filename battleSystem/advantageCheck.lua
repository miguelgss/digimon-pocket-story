...
local attributeChart = {
    --  F | W | P | EA | EL | W | L | D
    { 1,   0.5, 1.5, 1,   1,   1,   1,   1 },    -- FIRE       1
    { 1.5, 1,   0.5, 1,   1,   1,   1,   1 },    -- WATER      2
    { 0.5, 1.5, 1,   1,   1,   1,   1,   1 },    -- PLANT      3
    { 1,   1,   1,   1,   1.5, 0.5, 1,   1 },    -- EARTH      4
    { 1,   1,   1,   0.5, 1,   1.5, 1,   1 },    -- ELETRIC    5
    { 1,   1,   1,   1.5, 0.5, 1,   1,   1 },    -- WIND       6
    { 1,   1,   1,   1,   1,   1,   0.5, 1.5 },  -- LIGHT      7
    { 1,   1,   1,   1,   1,   1,   1.5, 0.5 }   -- DARK      8
}
